    ...
    Tables: {
      ...
      estimates: {
        Row: {
          ...
          signoff_customer_name: string | null;
          signoff_ip_address: string | null;
          created_at: string;
          updated_at: string;
        };
        Insert: {
      ...
      estimate_signoffs: {
        Row: {
          ...
          acknowledged_scope: boolean;
          acknowledged_materials: boolean;
          acknowledged_areas: boolean;
          acknowledged_terms: boolean;
          scope_summary: string | null;
          materials_summary: string | null;
          areas_summary: string | null;
          signed_at: string;
          created_at: string;
        };
        Insert: {
